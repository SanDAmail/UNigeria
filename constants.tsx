...
import { Profile, ForumCategory, Topic, Persona, PersonSubtype, PersonaType, Message } from './types';
...
export const INITIAL_FORUM_CATEGORIES: ForumCategory[] = [
    { id: 'town-halls', name: 'Town Halls', description: 'Discuss national policies and current events.', icon: <Icons.UserGroup className="w-12 h-12 text-primary-green" />, topics: 1, posts: 2 },
    { id: 'community-projects', name: 'Community Projects', description: 'Organize and discuss local initiatives.', icon: <Icons.Flag className="w-12 h-12 text-primary-green" />, topics: 1, posts: 1 },
];

const defaultUser = { name: 'Citizen Ade', avatar: 'https://picsum.photos/seed/ade/40/40' };

export const TOPICS_DATA: { [categoryId: string]: Topic[] } = {
    'town-halls': [
        { id: 'topic-1', title: 'Discussion on the new Fuel Subsidy Policy', author: { name: 'Admin', avatar: 'https://picsum.photos/seed/admin/40/40' }, replyCount: 1, lastReply: 'by AI Moderator', categoryId: 'town-halls' },
    ],
    'community-projects': [
        { id: 'topic-2', title: 'Idea: Weekly sanitation drive in our local market', author: defaultUser, replyCount: 0, lastReply: `by ${defaultUser.name}`, categoryId: 'community-projects' },
    ]
};

export const INITIAL_CHAT_HISTORY: { [chatId: string]: Message[] } = {
    'forum_town-halls_topic-1': [
